...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-slate-950 text-slate-200 overflow-hidden font-sans relative">
      ...
      {toastMessage && (
        <div className="fixed bottom-10 left-1/2 -translate-x-1/2 bg-slate-900/90 backdrop-blur-2xl text-white px-8 py-5 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-slate-700 flex items-center gap-4 font-black z-[9999] transition-all duration-500 transform translate-y-0 opacity-100 min-w-[300px] justify-center animate-in slide-in-from-bottom-10 fade-in">
